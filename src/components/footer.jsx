...
const Footer = () => {
    return (
        <div className="relative w-full  py-24 flex flex-col justify-center items-center bg-black text-white text-center font-os gap-9">

            {/* <!-- 1-element (OOO “MASSHTAB UNIVERSITY” va boshqalar) --> */}
            <div className="w-10/12  text-[19px] leading-[19px]">
            ...
            <div className="w-10/12 text-[48px] leading-[48px]">
                <a href="tel:998937767700" className="text-white">+998 78 113 79 00</a>
            </div>

            {/* <!-- 3-element (Zamonaviy kasblar ta’lim markazi) --> */}
            <div className="w-10/12  text-[22px] leading-[22px]">
                <div className="text-white">
