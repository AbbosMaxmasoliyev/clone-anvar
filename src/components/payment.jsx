...
import { sendDataToGoogleScript } from '../utils/sendDataToGoogleScript';
...
const Payment = (props) => {
    ...
    const handleSubmit = async (event) => {
        ...
        if (files.length === 0) {
            ...
            // Assuming sendPhotoToBot is defined elsewhere
            const message = `
  *New Submission!*
  *Name:* ${fullName}
  *Phone:* ${phoneNumber}
  ...
  *Status:* ${status}
        `;
            await sendPhotoToBot(files[0], message);
                        ...
                        <div className="flex justify-end">
                            <div className="flex">
                                ...
                                <div className="my-auto">
                                    <img className="rounded-full w-12 h-12" onDragStart={() => false} src={"/avatar.png"} alt="avatar" />
                                </div>
                            </div>
                        </div>
                    </header>
                            ...
                            <div className="z-10 flex items-center justify-between">
                                ...
                                <div className="px-[30px] py-[12px] font-medium text-white bg-white rounded-xl">
                                    <div className="text-[#d1444e] text-[18px]" id="timer">
                                        <Countdowntimer targetDate={new Date().getTime() + 90000} />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="flex hidden bg-white rounded-xl shadow-black/5 border-stone-200" id="timeout">
                        ...
                        <div className="ml-2">
                            ...
                            <p className="text-[14px] font-medium text-[#535888]">
                                Lekin biz allaqachon siz uchun yangi tulov havolasini yaratdik:
                            </p>
